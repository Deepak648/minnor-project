...
PATH_TO_CKPT = 'D:/minor/Snake-Game-Using-Tensorflow-Object-Detection-API-master/inference_graph/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('images/data', 'D:/minor/Snake-Game-Using-Tensorflow-Object-Detection-API-master/object-detection.pbtxt')
